package com.atguigu.springcloud.algorithm.service.impl;

import com.atguigu.springcloud.algorithm.service.MyMap;
...
public class MyHashMap<K, V> implements MyMap<K, V> {
    ...
    private int hash(K key){
        int h;
        /*System.out.println(Math.abs((h = key.hashCode())));
        System.out.println((h >>> 16));
        System.out.println(Math.abs((h = key.hashCode())) ^ (h >>> 16));*/
