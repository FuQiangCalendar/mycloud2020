...
public class FactoryModeTest {
    ...
    */
    public static void test1 () {
        ...
        log.info("输出数字：" + parse.toString());
    }

    public static void test2 () {
        Calendar instance = Calendar.getInstance();
        LocalDateFactory localDateFactory = LocalDateFactory.getLocalDateFactory();
        LocalDate parse = localDateFactory.parse(instance.getTime().getTime());
        log.info("输出日期：" + parse.toString());
    }
