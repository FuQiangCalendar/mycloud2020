...
/**
 * @Package com.atguigu.springcloud.behavior_designmode.test
 * @ClassName VisitorModeTest
 * @Description 行为型模式 -- 访问者
 *
...
public class VisitorModeTest {
    ...
    public static void main(String[] args) throws Exception{
        String filePath = "C:\\Users\\Administrator\\Desktop\\开发日志\\备份代码";
        test1(filePath);
        test2(filePath);
    }

    public static void test1 (String filePath) {
        FileStructure fs = new FileStructure(new File(filePath));
        fs.handle(new JavaFileVisitor());
    }

    public static void test2(String filePath) throws IOException {
        Files.walkFileTree(Paths.get(filePath), new MyFileVisitor());
    }
}
