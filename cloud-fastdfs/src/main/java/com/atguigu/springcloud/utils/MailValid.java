...
//        System.out.println(new MailValid().valid("fq2295827430@136.com", "jootmir.org"));
//        System.out.println(new MailValid().valid("wq@qq.com", "jootmir.org"));
    	System.out.println(new MailValid().valid("fq2295827430@126.com", "qq.com"));
    }
    ...
    public static boolean valid(String toMail, String domain) {
        ...
        try {
            ...
            //base64加密的邮箱
            bufferedWriter.write("MjI5NTgyNzQzMEBxcS5jb20=\r\n");
            bufferedWriter.flush();
            if(getResponseCode(timeout, sleepSect, bufferedReader) != 334) {
                return false;
            }
            ...
            //base64加密的授权码
            bufferedWriter.write("Z3p1c3Rxa3psZmV3ZWJkaQ==\r\n");
            bufferedWriter.flush();
            ...
            // 身份
            bufferedWriter.write("MAIL FROM: <2295827430@" + domain + ">\r\n");
            bufferedWriter.flush();
            if(getResponseCode(timeout, sleepSect, bufferedReader) != 250) {
                return false;
            }
